...
: ${AMENT_CURRENT_PREFIX:="/app/project/install/my_robot_controller_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_robot_controller_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_robot_controller_test/environment/path.sh"
