...
: ${AMENT_CURRENT_PREFIX:="/app/project/install/meu_robo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/meu_robo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/meu_robo/environment/path.sh"
