...
: ${AMENT_CURRENT_PREFIX:="/src/install/meu_pacote"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/meu_pacote/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/meu_pacote/environment/path.sh"
